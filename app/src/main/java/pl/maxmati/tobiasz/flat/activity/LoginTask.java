...
import pl.maxmati.tobiasz.flat.api.session.AuthenticationException;
import pl.maxmati.tobiasz.flat.api.session.InvalidPasswordException;
...
import pl.maxmati.tobiasz.flat.api.session.UserNotFoundException;
